...
from keras_contrib.layers.crf import CRF as keras_CRF
...
class BiLSTMCRF(object):
    ...
    def __init__(self,
        ...
        self._use_keras_crf = use_keras_crf
    ...
    def build(self):
        ...
        if self._use_crf:
            if self._use_keras_crf:
                crf = keras_CRF(self._num_labels, sparse_target=False)
            else:
